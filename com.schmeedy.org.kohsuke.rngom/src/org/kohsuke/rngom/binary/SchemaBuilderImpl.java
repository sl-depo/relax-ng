...
//  }
  ...
  public ParsedPattern makeAttribute(ParsedNameClass nc, ParsedPattern p, Location loc, Annotations anno)
          throws BuildException {
    AttributePattern att = (AttributePattern) pb.makeAttribute((NameClass)nc, (Pattern)p, (Locator)loc);
    if (anno instanceof DocumentationAnnotationBuilder) {
    	Documentation doc = ((DocumentationAnnotationBuilder)anno).getDocumentation();
    	att.setDocumentation(doc);
    }
    return att;
  }
  ...
  public ParsedPattern makeElement(ParsedNameClass nc, ParsedPattern p, Location loc, Annotations anno)
          throws BuildException {
    ElementPattern element = (ElementPattern) pb.makeElement((NameClass)nc, (Pattern)p, (Locator)loc);
    if (anno instanceof DocumentationAnnotationBuilder) {
    	Documentation doc = ((DocumentationAnnotationBuilder)anno).getDocumentation();
  ...
  private DocumentationAnnotationBuilder annotations;
  
    public Annotations makeAnnotations(CommentList comments, Context context) {
		annotations = new DocumentationAnnotationBuilder();
		return annotations;
	}

  	private static class DocumentationAnnotationBuilder implements ElementAnnotationBuilder {
		...
		public ParsedElementAnnotation makeElementAnnotation() throws BuildException {
			return new Documentation(docBuilder.toString());
		}
		...
		public void addElement(ParsedElementAnnotation ea)	throws BuildException {
			if (ea instanceof Documentation) {
				documentation = (Documentation) ea;
			}
		}
  ...
  public ElementAnnotationBuilder makeElementAnnotationBuilder(String ns, String localName, String prefix,
    ...
    if (WellKnownNamespaces.RELAX_NG_COMPATIBILITY_ANNOTATIONS.equals(ns) && "documentation".equals(localName)) {
    	return annotations;
    } 
	return this;
  }
